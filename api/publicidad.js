export default async function handler(request, response) {
  ...
  try {
    ...
    endpoint.searchParams.set(
      "select",
      "id,titulo,descripcion,imagen_url,enlace,enlace_mercado_libre,enlace_amazon,precio_publicado,precio_cupon,codigo_cupon,plataforma,categoria,secciones,orden,clics,visitas,fecha_creacion,disponible_mercado_libre,disponible_amazon,es_nuevo,fecha_nuevo"
    );

export default async function handler(request, response) {
  ...
  try {
    ...
    endpoint.searchParams.set(
      "select",
      "id,titulo,descripcion,categoria_producto,imagen_url,enlace,enlace_mercado_libre,enlace_amazon,precio_publicado,precio_anterior,precio_cupon,codigo_cupon,plataforma,categoria,secciones,orden,clics,visitas,visitas_mercado_libre,visitas_amazon,fecha_creacion,fecha_expiracion,disponible_mercado_libre,disponible_amazon,es_nuevo,fecha_nuevo,es_mas_vendido,es_otra_recomendacion"
    );
